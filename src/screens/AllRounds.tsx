  ...
  for (const d of last6) {
    for (const h of d.holes) {
      ...
      for (const raw of [h.approach1_miss, h.approach2_miss]) {
        if (missPatternKey(raw)) clubMissRaw['드라이버'] += 1;
      }
          ...
          <>
            <div className="bg-[#e8f5ee] rounded-2xl border border-[#b6dfc8] p-4">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-sm font-bold text-[#1B4332]">나의 개선 포인트</h3>
              </div>
            ...
            <div className="bg-card rounded-2xl border border-gray-100 shadow-sm p-4">
              ...
              <div className="grid grid-cols-3 divide-x divide-gray-100">
                ...
                <div className="text-center px-2">
                  ...
                  <p className="text-2xl font-extrabold leading-none text-gray-800">{avgScore}<span className="text-xs font-normal text-gray-500 ml-0.5">타</span></p>
                </div>
                <div className="text-center pl-2">
                  <p className="text-[11px] text-gray-500 mb-1">평균 퍼팅</p>
                  <p className="text-2xl font-extrabold leading-none text-blue-500">{avgPutts}<span className="text-xs font-normal text-gray-500 ml-0.5">개</span></p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-card rounded-2xl border border-gray-100 shadow-sm p-4">
              ...
              <div className="space-y-3">
                {[
                  { label: '페어웨이 안착률', value: avgFairway, max: 100, display: `${avgFairway}%`, color: 'bg-[#1B4332]', textColor: 'text-[#1B4332]' },
