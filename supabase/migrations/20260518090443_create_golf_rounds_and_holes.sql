/*
  ...
  - course_name (text)
  - companion1, companion2, companion3 (text) - playing partners
  ...
  - par (int) - 3/4/5
  - green_shots, putts, total_strokes, over_par (int)
  - is_manual (bool)
  - Tee shot fields, second shots (x3), approach shots (x2), putt_memo

  ## Security
  - RLS enabled on both tables
  - anon + authenticated users can read/write (no login required)
*/
